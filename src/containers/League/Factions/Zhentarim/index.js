    ...
    <Box>
      ...
      >
        ...
        <Tabs.TabPane tab="Головна" key="main">
          <TextWithImage image={cover} text="Жентарім" />

          <Box my={30}>
            <Paragraph fontSize="16px">
              Жентарім - це безпринципова тіньова мережа, мета якої - поширити
              свій вплив на весь Фаерун. Організація амбіційна, опортуністична
              та вважає, що при владі мають бути лише достойні, в незалежності
              від їхнього економічного чи соціального стану.
            </Paragraph>
          </Box>

          <Box my={10}>
            <Paragraph fontSize="16px">
              Агент Жентаріму відчуває себе частиною великої сім’ї, покладаючись
              на Чорну Мережу в питаннях ресурсів та безпеки. Однак, члени
              організації користуються достатньою автономією, аби переслідувати
              власні інтереси, а також досягти певного рівня особистої
              могутності чи впливу.
            </Paragraph>
          </Box>
        </Tabs.TabPane>

    ...
    <Box>
      ...
      >
        ...
        <Tabs.TabPane tab="Головна" key="main">
          <TextWithImage image={cover} text="Смарагдовий Анклав" />

          <Box my={30}>
            <Paragraph fontSize="16px">
              Смарагдовий Анклав - це поширена група мешканців дикої місцевості,
              які зберігають природний стан речей та викорчовують усі
              протиприродні загрози. Члени цієї організації розсіяні по світу та
              схильні до відлюдності.
            </Paragraph>
          </Box>

          <Box my={10}>
            <Paragraph fontSize="16px">
              Агенти Смарагдового Анклаву розкидані по світу і переважно
              працюють ізольовано. Виживання в суворому світі також потребує
              серйозної виносливості та майстерності в мистецтві бою. Вони
              вчаться більше покладатись на власні сили, аніж на інших. Однак
              частина агентів Смарагдового Анклаву присвячують себе допомозі
              іншим для виживання серед небезпек диких земель.
            </Paragraph>
          </Box>
        </Tabs.TabPane>

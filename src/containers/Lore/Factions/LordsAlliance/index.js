        ...
        >
          ...
          <Box my={30}>
            <Paragraph fontSize="16px">
              Алянс Лордів - це вільна коаліція сталих політичних сил, що направлена на підтримку взаємної безпеки та
              процвітання. Ця організація відома своєю агресивністю, войовничістю та максимальною залученістю в
              політику.
            </Paragraph>
          </Box>
          ...
          <Box my={10}>
            <Paragraph fontSize="16px">
              Для того, щоб знайти та знищити небезпеку своїм рідним землям, агенти Альянсу Лордів мають бути дуже добре
              навчені. Мало хто може зрівнятись з ними на полі бою. Вони б’ються за славу та безпеку свого народу і
              своїх правителів, і роблять це з гордістю. Але Альянс Лордів може вистояти тільки якщо всі його члени
              будуть вести “чесну гру” між собою, що вимагає певної дипломатичності.
            </Paragraph>
          </Box>
        </Tabs.TabPane>

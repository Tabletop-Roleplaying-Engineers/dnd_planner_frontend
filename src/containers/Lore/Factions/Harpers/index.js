        ...
        >
          ...
          <Box my={30}>
            <Paragraph fontSize="16px">
              Арфісти - це широка мережа чаклунів та шпигунів, що відстоюють ідеали рівності та таємно протистоять
              зловживанню владою. Ця організація знає про багато речей, але мало хто знає про неї.
            </Paragraph>
          </Box>
          
          <Box my={10}>
            <Paragraph fontSize="16px">
              Агенти Арфістів навчені діяти самотужки та покладатись виключно на власні ресурси. Якщо вони потрапляють в
              неприємності, вони ніколи не розраховують, що інші Арфісти їх врятують. Не дивлячись на це, кожен Арфіст
              готовий прийти на поміч в час потреби, а дружба між агентами фракції практично непорушна. Майстри
              шпигунства та скритого проникнення, вони діють в тіні, застосовують багато фальшивих особистостей для
              створення союзів, розширення своєї мережі по збору інформації, а також маніпуляції іншими заради власних
              потреб.
            </Paragraph>
          </Box>
        </Tabs.TabPane>
